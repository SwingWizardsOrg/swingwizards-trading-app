...
class ChartApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Chart Application")
        self.setGeometry(100, 100, 800, 600)

        # Create a central widget (required for docking)
        central_widget = QWidget()
        self.setCentralWidget(central_widget)

        # Create and add the chart dock widget
        chart_dock = ChartDockWidget("Chart", self)
